 ...
 */
public class NotifyServiceWednesday extends Service implements LocationListener{
	...
	public class ServiceBinder extends Binder {
		NotifyServiceWednesday getService() {
			return NotifyServiceWednesday.this;
		}
	}
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		int c=40000+(intent.getExtras().getInt(p_id));
	...
	private void showNotification(int c) {
		int id=c-40000,itype=0,l;
		int minute=id%100;
		int hhour=id/100;
		Cursor s;
		String n_Title="error"+ c, n_class="error", n_room="error";
		dataBase = mHelper.getReadableDatabase();
		String query="Select * from "+DbHelper.TABLE_WED+" where "+DbHelper.KEY_HOUR+" ="+hhour + " AND " +DbHelper.KEY_MIN+" = "+minute;
		//String query1=
		//String query2=
		...
		//Notification sound and vibrate and LED
