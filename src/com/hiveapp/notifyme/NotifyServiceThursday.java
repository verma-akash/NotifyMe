 ...
 */
public class NotifyServiceThursday extends Service implements LocationListener{
	...
	public class ServiceBinder extends Binder {
		NotifyServiceThursday getService() {
			return NotifyServiceThursday.this;
		}
	}
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		/***************************************************************/
		int c=50000+(intent.getExtras().getInt(p_id));
	...
	private void showNotification(int c) {
		int id=c-50000,itype=0,l;
		int minute=id%100;
		int hhour=id/100;
		Cursor s;
		String n_Title="error"+c, n_class="error"+id, n_room="error";
		dataBase = mHelper.getReadableDatabase();
		String query="Select * from "+DbHelper.TABLE_THU+" where "+DbHelper.KEY_HOUR+" ="+hhour + " AND " +DbHelper.KEY_MIN+" = "+minute;
