 ...
 */
public class NotifyServiceFriday extends Service implements LocationListener{
	...
	public class ServiceBinder extends Binder {
		NotifyServiceFriday getService() {
			return NotifyServiceFriday.this;
		}
	}
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		/***************************************************************/
		int c=60000+(intent.getExtras().getInt(p_id));
	...
	private void showNotification(int c) {
		int id=c-60000,itype=0,l;
		int minute=id%100;
		int hhour=id/100;
		Cursor s;
		String n_Title="error", n_class="error", n_room="error";
		dataBase = mHelper.getReadableDatabase();
		String query="Select * from "+DbHelper.TABLE_FRI+" where "+DbHelper.KEY_HOUR+" ="+hhour + " AND " +DbHelper.KEY_MIN+" = "+minute;
		//String query1=
		//String query2=
